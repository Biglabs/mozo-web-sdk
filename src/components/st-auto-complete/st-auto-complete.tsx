/* ==========================================================================
 * Stencil Auto Complete
 *
 * @author: Tuan Nguyen (tuannguyen1702@gmail.com)
 * @project: st-auto-complete
 * @date: Oct 5 2018
 * @copyright: 2018 Tuan Nguyen
 * ==========================================================================
 */

import { Component, Prop, State, Event, EventEmitter } from '@stencil/core';
enum Trigger { hover = 'hover', click = 'click' };
...
@Component({
  tag: 'st-auto-complete',
  styleUrl: 'st-auto-complete.css',
  shadow: false
})
export class StPopupMenu {
  ...
  componentDidLoad () {
    ...
    document.addEventListener('click', (e) => {
      //this._switchToClickTrigger();

      console.log(this.popupEl.contains(e.target as HTMLElement))

      if(this.popupEl != (e.target) && this.targetEl != (e.target) && !this.popupEl.contains(e.target as HTMLElement))  
      {
        this._hidePopup();
      }
